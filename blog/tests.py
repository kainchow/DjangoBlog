...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        user = BlogUser.objects.get_or_create(
            email="zhoukai0607@gmail.com",
            username="zhoukai0607")[0]
        user.set_password("zhoukai0607")
        user.is_staff = True
        ...
        self.client.login(username='zhoukai0607', password='zhoukai0607')
        ...
        p = Paginator(
            Article.objects.filter(
                author__username='zhoukai0607'), settings.PAGINATE_BY)
        ...
        u = gravatar_url('zhoukai0607@gmail.com')
        u = gravatar('zhoukai0607@gmail.com')

        link = Links(
            sequence=1,
            name="kainchow",
            link='https://wwww.kainchow.net')
        link.save()
