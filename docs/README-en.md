...
[![Django CI](https://github.com/kainchow/DjangoBlog/actions/workflows/django.yml/badge.svg)](https://github.com/kainchow/DjangoBlog/actions/workflows/django.yml) [![CodeQL](https://github.com/kainchow/DjangoBlog/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/kainchow/DjangoBlog/actions/workflows/codeql-analysis.yml) [![codecov](https://codecov.io/gh/kainchow/DjangoBlog/branch/master/graph/badge.svg)](https://codecov.io/gh/kainchow/DjangoBlog) [![license](https://img.shields.io/github/license/kainchow/djangoblog.svg)]()  
...
>[DjangoBlog部署教程](https://www.kainchow.net/article/2019/8/5/58.html)
...
If you have any *question*, please use Issue or send problem descriptions to my email `zhoukai0607#gmail.com`. I will reponse you as soon as possible. And, we recommend you to use Issue.

---
## To Everyone 🙋‍♀️🙋‍♂️
If this project helps you, please submit your site address [here](https://github.com/kainchow/DjangoBlog/issues/214) to let more people see it.
